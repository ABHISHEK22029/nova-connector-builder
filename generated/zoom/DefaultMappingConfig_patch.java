...
import com.saba.integration.apps.zoom.VendorConstants_patch;
...
public enum DefaultMappingConfig {
    ...
    ADP_WFN_SABA_JOB_TITLES_JOBTYPE("ADP WFN SABA JOB_TITLES JOBTYPE", "IMPORT",
            ...
            "872110992997B303779D79778A5A8427",
            true),

    ZOOM_EDCAST_CONTENT("ZOOM EDCAST CONTENT", "EXPORT",
            VendorConstants_patch.ZOOM_INTEGRATION_ID,
            "integ00000000000000000000000000000002",
            "minea9c9f49999c448888b959679554777",
            "mpent00000000000000000000000000000002",
            "zoom_edcast_content.xml",
            "4B7B5A3A2D1C5B8A9A7E8F1C3A5E7B8A",
            true);
    ...
    DefaultMappingConfig(String mappingName, String type, String sourceIntegrationId, String targetIntegrationId, String sourceEntityId, String targetEntityId, String fileName, String md5checksum, boolean isValid) {
