{
  "components": [
    {
      ...
      "control": {
        ...
        "url": "sabaspel:payload.accountConfigs['BASE_URL'][0] + '/api/content?page=' + #currentPageNumber + '&page_size=' + (headers.headers['isPreview']==true ? '10' : '100')"
      },
      "requestMethod": "GET",
      "headers": {
        "Accept_Encoding": [
  ...
  "integrationId": "integ/mpent/minea3b304989b39448984a941b3927419c",
  "entityId": "mpent3c4aaaebfcefdf0cc7a73dad32c43ce0"
}