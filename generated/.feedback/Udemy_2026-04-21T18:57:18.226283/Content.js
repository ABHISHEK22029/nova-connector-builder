{
  "components": [
    ...
    },
    {
      ...
      "url": "sabaspel:headers.headers['UDEMY_CLIENT_URL'] + '/api-2.0/courses/?page_size=40'",
      "requestMethod": "GET",
      "headers": {
        "Accept-Encoding": [
          "gzip"
        ...
        "Authorization": [
          "sabaspel: 'Bearer ' + headers.headers['integrationDataFetchDetail'].accountConfigs['UDEMY_API_KEY'][0]"
        ]
      },
      "outputType": "FILE",
      "maxLoopCounter": "1",
