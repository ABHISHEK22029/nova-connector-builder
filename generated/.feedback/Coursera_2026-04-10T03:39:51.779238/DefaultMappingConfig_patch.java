...
import com.saba.integration.apps.coursera.VendorConstants_patch;
...
public enum DefaultMappingConfig {
    ...
    ADP_WFN_SABA_JOB_TITLES_JOBTYPE("ADP WFN SABA JOB_TITLES JOBTYPE", "IMPORT",
            ...
            "29999A509A3999767989799A9A99A999",
            true),

    COURSERA_EDCAST_CONTENT("COURSERA EDCAST CONTENT", "IMPORT",
            VendorConstants_patch.COURSERA_INTEGRATION_ID,
            "integ15746680281997bad7d050d8bd04dc70",
            "minea47e99989c824d9289594351a55c69a",
            "mpent1574694635123a21f3fc60d7fd04c9d0",
            "coursera_edcast_content.xml",
            "49D51A31891842179739896449896449",
            true);
    ...
    public static Optional<DefaultMappingConfig> fromMappingName(String mappingName) {
        return Arrays.stream(values())
                .filter(DefaultMappingConfig -> DefaultMappingConfig.mappingName.equals(mappingName))
                .findFirst();
    }

    public static Optional<DefaultMappingConfig> fromSourceEntityId(String sourceEntityId) {
        return Arrays.stream(values())
                .filter(DefaultMappingConfig -> DefaultMappingConfig.sourceEntityId.equals(sourceEntityId))
                .findFirst();
    }
}