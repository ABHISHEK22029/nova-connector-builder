...
public enum DefaultMappingConfig {
    ...
    ADP_WFN_SABA_JOB_TITLES_JOBTYPE("ADP WFN SABA JOB_TITLES JOBTYPE", "IMPORT",
            ...
            "89997972989960998E78258E17999999",
            true),

    UDEMY_EDCAST_CONTENT("UDEMY EDCAST CONTENT", "EXPORT",
            VendorConstants_patch.UDEMY_INTEGRATION_ID,
            "integ.mpent.minea.edcast",
            "mpent.minea.udemy",
            "mpent.minea.edcast.content",
            "udemy_edcast_content.xml",
            "67A9C5F39D2B4E81B7A2D63C9E1B8F04",
            true);
    ...
    public static Optional<DefaultMappingConfig> findBySourceAndTargetEntityId(String sourceEntityId, String targetEntityId) {
        return Arrays.stream(DefaultMappingConfig.values())
                .filter(e -> e.getSourceEntityId().equals(sourceEntityId) && e.getTargetEntityId().equals(targetEntityId))
                .findAny();
    }
