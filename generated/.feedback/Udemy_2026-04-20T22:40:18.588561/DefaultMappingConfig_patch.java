...
public enum DefaultMappingConfig {
    ...
    ADP_WFN_SABA_JOB_TITLES_JOBTYPE("ADP WFN SABA JOB_TITLES JOBTYPE", "IMPORT",
            ...
            "99901877D59994549888918999999999",
            true),
    ...
    UDEMY_EDCAST_CONTENT("UDEMY EDCAST CONTENT", "EXPORT",
            ...
            "mpent4ca4a959455a47698623123456789abc",
    ...
    DefaultMappingConfig(String mappingName, String flowType, String sourceIntegrationId, String targetIntegrationId, String sourceEntityId, String targetEntityId, String fileName, String checksum, boolean isValid) {
    ...
    public static Optional<DefaultMappingConfig> getDefaultMappingConfigByFileName(String fileName) {
        return Arrays.stream(DefaultMappingConfig.values())
