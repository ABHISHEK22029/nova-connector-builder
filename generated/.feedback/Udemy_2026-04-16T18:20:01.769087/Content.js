{
  "components": [
    ...
    },
    {
      ...
      "url": "sabaspel:headers.headers['UDEMY_API_URL'] + '/courses'",
      "requestMethod": "GET",
      "headers": {
        "Accept-Encoding": [
          "gzip"
        ...
        "Authorization": [
          "sabaspel:'Bearer ' + headers.headers['UDEMY_API_TOKEN']"
        ]
      },
      "outputType": "FILE",
      "maxLoopCounter": "1",
      ...
      "flowMetadata": {
        "successFlowMonitoring": {
          "defaultMessage": "Course Fetch Complete",
          "status": "COMPLETE",
          "details": {
            "STEP_COMPLETED": "1"
          }
        ...
        "errorFlowMonitoring": {
          "defaultMessage": "Course fetch resulted in failure",
          "details": {
            "SABA_EXCEPTION": "sabaspel:headers.headers['SABA_EXCEPTION']",
            "INTEGRATION_MONITORING_ID": "sabaspel:headers.headers['INTEGRATION_MONITORING_ID']"
          },
  ...
  "flow": {
    ...
    "errorComponentName": "MONITORING_CHECK_EXCEPTION",
    "routing": {
      "MONITORING_STATUS_CHECK": {
        "FAILURE": "MONITORING_CHECK_EXCEPTION",
        "default": "UDEMY_COURSE_HTTP_COMPONENT"
      },
      "UDEMY_COURSE_HTTP_COMPONENT": {
        "FAILURE": "MONITORING_CHECK_EXCEPTION",
        "default": "UDEMY_COURSE_JSON_TO_XML"
      },
      "UDEMY_COURSE_JSON_TO_XML": {
        "FAILURE": "MONITORING_CHECK_EXCEPTION",
        "default": "UDEMY_COURSE_XML_MERGER"
      },
      "UDEMY_COURSE_XML_MERGER": {
        "FAILURE": "MONITORING_CHECK_EXCEPTION",
        "default": "UDEMY_COURSE_XSLT"
      },
      "UDEMY_COURSE_XSLT": {
        "FAILURE": "MONITORING_CHECK_EXCEPTION"
      }
